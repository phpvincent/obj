...
<!-- End Facebook Pixel Code -->
    ...
    <div class="detail-context" style="border-bottom: 1px dashed #dcdcdc;padding:10px 2px;height:50px;">
        <div class="dc-price" style="background:#fff;">
            <span class="s-price" style="font-size:24px">NT${{$goods->goods_price}}</span>
            <span class="o-price" style="font-size:12px">NT${{$goods->goods_real_price}}</span>
        </div>
    ...
    {{--抢购模块--}}
    @if(in_array('count_down',$templet))
    <div class="timebox">
    ...
    {{--活动描述--}}
    @if(in_array('description',$templet))
    ...
    {{--中部导航--}}
    @if(in_array('center_nav',$templet))
    ...
    <div class="detail-block" id="detial-context" style="padding-top:10px">
        ...
        <p>
            <video class="edui-upload-video  vjs-default-skin    video-js" controls="" autoplay="autoplay" preload="auto" width="420" height="280" src="{{$goods->goods_video}}" data-setup="{}"><source src="" type="video/mp4"/></video>
        </p>
        @endif
        <p>
                 ...
                 <div id="mq">
                    <div id="mq1">
                        ...
                        <div class="appr-title mqc">
                            ...
                            <span>滿意度：
                                <font color="red">@for($i=0;$i<$v->com_star;$i++)★@endfor</font>
                            </span>
    ...
    <div style="padding:0px;padding-bottom: 10px;" class="table_details" id="detial-table">
             <table class="data-table">
                <tbody>
                    ...
                    <tr class="first odd">
                        <td colspan="2">
                            <p>1.由於個人原因產生的退換貨：至收到商品之日起7天內，在不影響二次銷售的情況下請聯繫我們的在線客服或發郵件至
                                <a href="https://mail.google.com/mail/" style="color:#F8770E">hyfhdcjn@gmail.com</a>
                                ，售後客服會在收到消息後的1-3個工作日內受理您的請求，退換貨所產生的運費需自行承擔。
                            </p>
                            <p>
                                2.由於質量原因產生的退換貨：至收到商品之日起7天內，向售後服務中心發送郵件至
                                <a href="https://mail.google.com/mail/" style="color:#F8770E">hyfhdcjn@gmail.com</a>
                                ，客服會在收到郵件後的1-3個工作日內受理您的請求，退換貨所產生的運費由我方承擔。
                            </p>
                        </td>
                    </tr>
                    <tr class="first odd">
                    ...
                    <tr class="first odd">
                        ...
                        <td colspan="2">
                            <p>確認收貨—申請退換貨—客服審核通過—用戶寄回商品—倉庫簽收驗貨—退 換貨審核—退款/換貨；</p>
            ...
            <div class="Product_assurance" style="padding:0px; text-align:center; margin-bottom:15px;font-size: 14px; background:#3d69a6; color:#fff; height:40px; line-height:40px; ">
