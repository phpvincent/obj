...
<div class="mui-input-group">
    ...
    <div class="mui-input-row">
        ...
        <input type="text" name="firstname" datatype="s1-30" placeholder="必填，填写收件人姓名" nullmsg="填写收件人姓名" class="mui-input-clear">
    </div>
  ...
  <!--   <div class="mui-input-row">
    ...
    <div class="mui-input-row">
        ...
        <input type="text" datatype="z1-300" placeholder="必填，具体到街道门牌信息" nullmsg="街道门牌信息" errormsg="address_not_correct" name="address1" class="mui-input-clear">
    </div>
    <div class="mui-input-row" style="display:none;">
