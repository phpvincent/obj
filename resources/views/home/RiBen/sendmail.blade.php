...
<body >
        ...
        <table width="800" border="0" align="center" cellpadding="0" cellspacing="2" style="background-image: url();">
          ...
          <tr>
            <td height="40" colspan="3">
              ...
              <div align="right"style=" padding: 20px 0 0 20px;color:#666;font-size:14px;margin-bottom:30px">
                ...
                <div style="text-align: right;">
                  <p style="display:inline-block;margin: 6px 0;">個数 :</p><p style="display:inline-block;width: 100px;;margin: 6px 0;text-align: right;padding-left: 4px">{{$order->order_num}}</p>
                </div>
                <div style="text-align: right;">
          ...
          "><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">このメールは、</font></font><a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><a style="color:#F8770E" target="_blank" href="http://{{$url}}">{{$url}}</a></font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">での注文確認するためのみとなります。 
                 ...
                 </font></font><a href="mailto:esdkhjes@gmail.com" style="color:#F8770E">esdkhjes@gmail.com</a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> にメールしてください。</font></font></p></td>
          </tr>
          <tr>
            ...
            <a href="mailto:esdkhjes@gmail.com" ><font  style="vertical-align: inherit;"><font style="vertical-align: inherit;"><a style="color:#F8770E" target="_blank" href="http://{{$url}}">{{$url}}</a></font></font></a>
            </p></td>
          </tr>
        </tbody></table>
        <p>&nbsp;</p>
