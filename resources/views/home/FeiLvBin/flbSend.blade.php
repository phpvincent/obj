  			...
  			<div style="padding:14px 20px 10px 20px;text-align:left;  background-color:#eee;color:#7B7A7A; margin-top:5px;">
               <p style="margin-bottom:0;"></p>
				<div class="buyinfo_note" style=" line-height:16px;">
					...
					If you have any questions about your product, please contact online customer service or send an email to<a href='mail:isnfclpo@gmail.com' style='color:#F8770E'>isnfclpo@gmail.com</a>.At the same time, please inform your name / contact information / order number, we will quickly give you timely processing, I wish you a good shopping!			</div>
				<p></p>
  			</div>
		</div>
