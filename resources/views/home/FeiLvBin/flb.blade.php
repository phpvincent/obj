...
<!-- End Facebook Pixel Code -->
       ...
       <script type="text/javascript" src="/js/resizeDIV.js"></script>
        ...
        <script type="text/javascript">
           window.addEventListener("load",function(){window.chatUrl="http://13.229.73.221/chat";var l='{"goods_id":{{$goods->goods_id}},"lan":"{{\App\goods::get_talk_lan($goods->goods_id)}}"}';window.chatConfig=JSON.parse(l);window.chatUrl+="?goods_id="+window.chatConfig.goods_id+"&lan="+window.chatConfig.lan;var b=document.createElement("div");b.id="elementToDrag";b.style='position:fixed;right:0px;bottom:13%;width:70px;height:70px;border-style: 1px solid black;background:url("https://gss1.bdstatic.com/9vo3dSag_xI4khGkpoWK1HF6hhy/baike/w%3D268%3Bg%3D0/sign=921106c5855494ee8722081f15ce87c3/29381f30e924b899c8cefe4267061d950b7bf6de.jpg");background-size: 100%;z-index:99999999999';document.body.append(b);b.onclick=function(){location.href=window.chatUrl};var m=0;var k=0;var e=false;var h=false;var d;var f=0;var g="elementToDrag";var c=parseInt(document.getElementById(g).style.width.split("p")[0]);var j=parseInt(document.getElementById(g).style.height.split("p")[0]);function n(a){d=a;e=true;a.style.cursor="hand";event.srcElement.setCapture();m=a.style.pixelLeft-event.x;k=a.style.pixelTop-event.y}document.onmousemove=function(){if(d!=null&&typeof(d)!="undefined"){if(e){if(h){d.style.filter="Alpha(opacity=30)"}if(event.x<=document.documentElement.clientWidth-c&&event.x>=c&&event.y<=document.documentElement.clientHeight+f-j&&event.y>=j+f){d.style.pixelLeft=m+event.x;d.style.pixelTop=k+event.y}}}};document.onmouseup=function(){if(d!=null&&typeof(d)!="undefined"){e=false;if(h){d.style.filter="Alpha(opacity=100)"}d.style.cursor="default";event.srcElement.releaseCapture();d=null}};document.onscroll=function(){var o=document.body.scrollTop?document.body.scrollTop:document.documentElement.scrollTop;var a=document.getElementById(g);a.style.pixelTop+=(o-f);f=o};function i(){var a=document.documentElement.clientWidth*0.8;var q=document.documentElement.clientHeight*0.1;var p=document.body.scrollTop?document.body.scrollTop:document.documentElement.scrollTop;var q=p+q;var o=document.getElementById(g);o.style.pixelLeft=a;o.style.pixelTop=q}i()},false);    
        </script>
	</head>
