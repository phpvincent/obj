...
{{--            @if($goods->goods_comment_num!=0||$goods->goods_comment_num!=''||$goods->goods_comment_num!=null)--}}
    ...
    <tbody>
        ...
        <tr class="first odd">
            <td colspan="2">
                <p>
                قد تختلف نتائج هذا المنتج وفقا لاختلاف الاشخاص ,لا نضمن نفس النتائج لجميع العملاء ,لجميع الشكاوي والاستفسارات نرجو منكم التواصل معنا عبر البريد الالكتروني(<a href="mailto:hyfhdcjn@gmail.com" style="color:#F8770E">hyfhdcjn@gmail.com</a>) او خدمه العملاء ,تحتفظ الشركه بحقوق الرد النهائيه . 
                </p>
            </td></tr>
        @endif
        ...
        <tr class="first odd">
            <td colspan="2">
                <p>                 
                        طلب ارجاع أو استبدال المنتج لاسباب شخصيه :في خلال 7 أيام من تاريخ استلام المنتج بشرط أن يكون المنتج في حالته الاصليه ,من فضلك تواصل مع خدمه العملاء او عبر البريد الالكتروني (<a href="mailto:hyfhdcjn@gmail.com" style="color:#F8770E">hyfhdcjn@gmail.com</a>),سيتم التعامل مع الامر في خلال 3 ايام عمل من تاريخ استلام الطلب ,يتحمل العميل كافه مصاريف الشحن .
                </p>
                <p>
                                        
                                        طلب ارجاع أو استبدال المنتج لاسباب تتعلق بجودة المنتج :تواصل مع خدمه العملاء في خلال 7 أيام من تاريخ استلام المنتج ,او تواصل معنا عبر البريد الالكتروني (<a href="mailto:hyfhdcjn@gmail.com" style="color:#F8770E">hyfhdcjn@gmail.com</a>),سيتم الرد عليك في خلال 3 ايام عمل من تاريخ استلام الطلب ,ستتحمل الشركه مصاريف الشحن .                                             
                </p>
            </td></tr>
            @endif
...
<div class="mui-bar" style="box-shadow: 0px -1px 1px #dad8d8;margin:0 auto;max-width:640px;">
    ...
    <span class="query" id="track_online" onclick="location.href='/send?goods_id={{$goods->goods_id}}'" style="width: {{in_array('now_buy',$templets) ? '30%' : '100%'}}">
      ...
      <a href="javascript:void(0);">
        <span style="line-height:14px;">اطلب<br>استعلامات</span>
      </a>
    </span>
    @endif
