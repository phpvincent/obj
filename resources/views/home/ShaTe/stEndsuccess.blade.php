...
<script language="javascript">
    ...
    function copyOrder (){
        ...
        var text = document.getElementById("copyOrder").innerText;
            ...
            // mui.toast('已复制好，可贴粘。')
            layer.msg("نسخ ب النجاح");
    }
</script>
                                            <!-- من فضلك لا تغلق الهاتف ,من أجل سهوله التواصل مع موظف الشحن ,اذا لديك أي استفسارات ,من فضلك تواصل معنا عبر خدمه اعملاء او من خلال البريد الالكتروني ,نتمني لكم تسوق سعيد . <a href="mailto:yejforlh@gmail.com" style="color:#F8770E">yejforlh@gmail.com</a> -->
