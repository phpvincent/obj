...
<body >
        ...
        <table width="800" border="0" align="center" cellpadding="0" cellspacing="2" style="background-image: url();">
          ...
          <tr>
          <td ><div style="text-align:  center;"><font style="vertical-align: inherit; font-size: 32px;font-weight: bold; color: #F29400;">ยืนยันรายการสั่งซื้อ</font></div></td>
          </tr>
          ...
          <tr>
              ...
              line-height: 28px;">
                <div style="width:70%;margin:0 auto;    text-align: center;">
                    ...
                    <p style="margin:0"><font style="vertical-align: inherit;">วิธีการชําระเงิน : @if($order->order_pay_type=='0')เก็บเงินปลายทาง@elseำระเงินออนไลน์@endif</font></p>
                    <p style="margin:0"><font style="vertical-align: inherit;">หมายเหตุ : @if($order->order_remark!=null){{$order->order_remark}}@endif</font></p>
                </div>
                <div style="width:70%;margin:0 auto;    text-align: center;">
                  <p style="margin:0">ที่อยู่ผู้รับของ :&nbsp;{{$order->order_state}} {{$order->order_city}}</p>
                  <p style="margin:0">รายละเอียดที่อยู่ :&nbsp;{{$order->order_add}}</p>
                  <p style="margin:0">เบอร์ติดต่อ :&nbsp;{{$order->order_tel}} </p>
                  @if($order->order_email!=null)
                  <p style="margin:0">Email : {{$order->order_email}}</p>
                  @endif
                  @if($order->order_zip!=null)
                  <p style="margin:0">รหัสไปรษณีย์ :&nbsp;{{$order->order_zip}} </p>
                  @endif
              </div>
              </td>
          </tr>
          ...
          <tr>
            <td height="20" colspan="3" style=" border-top: 1px solid #F29400; color: #F29400;"><p style="    text-align: center;"><strong><font style="vertical-align: inherit;">ข้อมูลสินค้า</font></strong></p></td>
          </tr>
          <!-- <tr>
            ...
            <td colspan="3"    style=" padding: 20px 0 0 20px;color:#666;font-size:14px">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
                        ...
                        <td width="585" colspan="2" style=" padding-left: 20px;">
                            ...
                            <p style="margin: 0; ">
                            โปรโมชั่น :{{$order->order_cuxiao_id}}
                            </p>
                            @endif
                        </td>
                    </tr>
            ...
            <td height="40" colspan="3">
              ...
              <div align="right"style=" padding: 20px 0 0 20px;color:#666;font-size:14px;margin-bottom:30px">
                ...
                <div style="text-align: right;">
                  <p style="display:inline-block;margin: 6px 0;">ราคาต่อหน่วย :</p><p style="display:inline-block;width: 100px;;margin: 6px 0;text-align: right; padding-left: 4px">{{$order->order_currency}}{{$goods->goods_price}}</p>
                </div>
                <div style="text-align: right;">
                  <p style="display:inline-block;margin: 6px 0;">จำนวนชิ้น :</p><p style="display:inline-block;width: 100px;;margin: 6px 0;text-align: right;padding-left: 4px">{{$order->order_currency}}{{$order->order_num}}</p>
                </div>
                <div style="text-align: right;">
                  <p style="display:inline-block;margin: 6px 0;">ราคา โปรโมชั่น :</p><p style="display:inline-block;width: 100px;;margin: 6px 0;text-align: right;padding-left: 4px">{{$order->order_currency}}{{($goods->goods_price*$order->order_num)-($order->order_price)}}</p>
                </div>
                <div style="text-align: right;">
                  <p style="display:inline-block;margin: 6px 0;">จัดส่งฟรี :</p><p style="display:inline-block;width: 100px;;margin: 6px 0;text-align: right;padding-left: 4px">{{$order->order_currency}}0</p>
                </div>
                <div style="text-align: right;">
                  <p style="display:inline-block;margin: 6px 0;">ยอดเงินรวม :</p><p style="display:inline-block;width: 100px;;margin: 6px 0;text-align: right;padding-left: 4px">{{$order->order_currency}}{{$order->order_price}}</p>
                </div>
              </div>
              @else
              <div align="right"style=" padding: 20px 0 0 20px;color:#666;font-size:14px;margin-bottom:30px">
