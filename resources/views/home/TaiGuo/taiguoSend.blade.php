            ...
            <div style="width:100%; background:white;">
  			...
  			<div style="padding:14px 20px 10px 20px;text-align:left;  background-color:#eee;color:#7B7A7A; margin-top:5px;">
               <p style="margin-bottom:0;"></p>
                ...
                ถ้าลูกค้าได้รับสินค้าแล้วมีคำถามหรือข้อสงสัยกับสินค้า สามารถติดต่อสอบถามผ่านระบบบริการลูกค้าออนไลน์หรือส่งอีเมลไปถึงที่<a href='https://mail.google.com/mail/' style='color:#F8770E'>hyfhdcjn@gmail.com</a>โดยระบุชื่อ-นามสกุล เบอร์โทรศัพท์และเลขที่การสั่งซื้อสินค้า หลังจากได้รับข้อมูลเจ้าหน้าจะติดต่อกลับโดยเร็วที่สุด ขอให้ทุกท่านเพลิดเพลินกับการชอปปิง</div>
				<p></p>
  			</div>
		</div>
