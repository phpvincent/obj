...
<header class="mui-bar mui-bar-nav" style="background:#fff;">
    ...
    <div class="pay_success">
            <h2 style="padding:16px 0px 10px 0px; text-align:center; color:#3cba92">สั่งซื้อสินค้าสำเร็จ！</h2>
                            ...
                            เลขที่คำสั่งซื้อของท่าน:<font color="red"style="user-select: text;" id="copyOrder">{{$order->order_single_id}}</font>
            ...
            <div align="center" style="padding:0px 15px">
                <button type="button" class="succuss_center_a" style="" onclick="goHome()">กลับหน้าหลัก&gt;&gt;</button>
            </div>
    </div>
</div>
