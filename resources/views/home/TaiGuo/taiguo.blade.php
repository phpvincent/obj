...
<table class="data-table">
    ...
    <tbody>
        ...
        <tr class="first odd">
            <td colspan="2">
                <p>
                ผลการใช้จริงของผลิตภัณฑ์นี้ขึ้นอยู่กับแต่ละสถานการณ์ของแต่ละคน ไม่รับรองว่าถูกคนจะได้มีผลการใช้ตามการโฆษณา าลูกค้าได้รับสินค้าแล้วมีคำถามหรือข้อสงสัยกับสินค้า สามารถติดต่อสอบถามผ่านระบบบริการลูกค้าออนไลน์หรือส่งอีเมลไปถึงที่<a  href="https://mail.google.com/mail/" style="color:#F8770E">uoewtnxj@gmail.com</a>และบริษัทมีสิทธิอธิบายสุดท้าย
            </td></tr>
        @endif
