...
<div class="mui-content" style="background:#fff">
  <div class="wwddcc">
	...
	số đơn đặt hàng, số đơn vận chuyển (điền một số thì có thể thẩm tra ) 		<!--（<font style=" font-size:14px;">一つだけ記入すればいい</font>）-->
</div>
	<div class="textbox">
		<form id="queryForm" action="/product/trackingform" method="post">
			<input name="queryNo" value="" id="txtkey" class="text" placeholder="điền vào thông tin liên quan 　thẩm tra " type="text">
		</form>
	</div>
	<a id="btnQuery">thẩm tra ngay</a>
	...
	<div class="clear"></div>
        ...
        <div style="padding:0px;padding-bottom: 10px;">
            <div style="width:100%; background:white;">
								<div style="width:100%; background:white;"><img src="/images/zd_kuaiditu.jpg" width="100%"></div>			</div>
  			<div style="padding:14px 20px 10px 20px;text-align:left;  background-color:#eee;color:#7B7A7A; margin-top:5px;">
               <p style="margin-bottom:0;"></p>
				<div class="buyinfo_note" style=" line-height:16px;">
					<strong>nhắc nhở ấm:</strong>
					 Sau khi nhận hàng có vấn đề gì xin vui lòng liên hệ phục vụ khách hàng trên mạng của chúng tôi hoặc gửi email đến
										<a href='mailto:hyfhdcjn@gmail.com' style='color:#F8770E'>hyfhdcjn@gmail.com</a> .Đồng thời báo cho chúng tôi tên họ/cách liên hệ /số đơn đặt hàng của ông, chúng tôi sẽ giải quyết ngay cho quý khách  chúc ông mua bán vui vẻ! </div>
				<p></p>
  			</div>
		</div>
        <div class="back_index"><a href="javascript:history.go(-1);" style="color:#fff">quay lại trang chủ </a></div>
  </div>
    ...
    $(function (){
		...
		$("#btnQuery").click(function(e) {
			if($("input[name='queryNo']").val()==''){
				alert('số đơn đặt hàng, số đơn vận chuyển (điền một số thì có thể thẩm tra ) ');
				return;
			}
            $("#queryForm").submit();
        });
        	 ...
        	 $.ajax({
                ...
                success:function(msg){
                	if(msg!='false'){
                		  ...
                		  $('.details').html("<span style='color:#f00;'>Số đơn đặt hàng sai lầm, không có tin tức tương đối, xin vui lòng viết lại </span>");
                	}
