<div class="product_image">
	    ...
	    <div class="check_show">
	        ...
	        <h2><b>Your order status: </b>@if($order->order_type==0)Not checked @elseif($order->order_type==1)Nuclear approval @elseif($order->order_type==2)<span style="color: red;">confirm failed</span>@elseif($order->order_type==3) despatched to the Express company elseif($order->order_type==4)Signed elseif($order->order_type==5||$order->order_type==6||$order->order_type==7)<span style="color: red;">returns processing</span>@elseif($order->order_type==8)<span style="color: red;"> signature rejected</span>@else &nbsp; @endif</h2>
