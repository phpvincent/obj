...
<div class="pro_info">
    <div class="ctxthead">
        ...
        <div class="rpricebox">$<span id="price">{{$goods->goods_price}}</span></div>
    </div>
	                       ...
	                       $('#addcart-quantity-inc').bind('click',function(){
                            ...
                            $('.addcart-float-buttons-block').children('button').click(function(){    	
                            	...
                            	if(attr=='chose_cart'){
                                   ...
                                   pricehtml.html("$"+price);       //填上自定义价格无需计算；
