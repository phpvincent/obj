...
<!-- <body style=""><header class="mui-bar mui-bar-nav" style="background:#fff;">
    ...
    <div class="pay_success">
            <h2 style="padding:16px 0px 10px 0px; text-align:center; color:#3cba92">تم الطلب بنجاح</h2>
                <div style="padding:15px;">
                <font color="red"style="user-select: text;">{{$order->order_single_id}}</font>:رقم الطلب الخاص بك <br>
