...
<body >
        ...
        <table width="800" border="0" align="center" cellpadding="0" cellspacing="2" style="background-image: url();">
          ...
          <tr>
            <td colspan="3"    style=" padding: 20px 0 0 20px;">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
                        ...
                        <td width="585" colspan="2" style=" padding-left: 20px;">
                            <p style="margin:6px 0 10px 0; "><font style="vertical-align: inherit;color:#666;font-size:14px"><font style="vertical-align: inherit;">{{$goods->goods_name}}</font></font></p>
                            <p style="margin: 0; ">
