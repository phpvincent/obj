...
<div class="mui-content" style="background:#fff">
  <div class="wwddcc">
	...
	<div style="color: #39424a; line-height: 2">
		订单号/物流单号（填写一项即可查询）		<!--（<font style=" font-size:14px;">一つだけ記入すればいい</font>）-->
</div>
	<div class="textbox">
		<form id="queryForm" action="/product/trackingform" method="post">
			<input name="queryNo" value="" id="txtkey" class="text" placeholder="填写相关信息查询" type="text">
		</form>
	</div>
	<a id="btnQuery">立即查询</a>
        	 ...
        	 $.ajax({
                ...
                success:function(msg){
                	if(msg!='false'){
                		  ...
                		  $('.details').html("<span style='color:#f00;'>订单号码错误，无对应信息，请重新输入</span>");
                	}
