...
<body style="max-width: 1190px;"><header class="mui-bar mui-bar-nav" style="background:#fff;max-width: 1190px;">
    ...
    <div class="pay_success">
            <h2 style="padding:16px 0px 10px 0px; text-align:center; color:#f00">Order submission failed! </h2>
                           
                                <div style="text-align:left;padding:10px 15px 20px">
                                            <!--同一个币种不同团队的邮箱不一样-->
                                            Please return to resubmit the order !         </div>
            <div align="center" style="padding:0px 15px">
                <button type="button" class="succuss_center_a" style="" onclick="goHome();">Return&gt;&gt;</button>
            </div>
    </div>
</div>
