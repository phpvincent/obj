...
<script type="text/html" id="test-table-sku">
    @{{# if (d.goods_kind_sku_status=== '0') { }}
        <button class="layui-btn layui-btn-primary layui-btn-sm" style="border-radius: 0;">
             <b style="color:green;" onclick="goods_show('SKU状态','{{url("admin/kind/sku_show")}}?id='+@{{ d.goods_kind_id }},2,1400,800)">正常</b>
        </button>
    @{{# } else if(d.goods_kind_sku_status=== '1') { }}
        <button  class="layui-btn layui-btn-primary layui-btn-sm" style="border-radius: 0;color:#ccc;">
           <b style="color:#f51322;" onclick="goods_show('SKU状态','{{url("admin/kind/sku_show")}}?id='+@{{ d.goods_kind_id }},2,1400,800)">已释放</b>
        </button>
    @{{# } else { }}
        <button class="layui-btn layui-btn-primary layui-btn-sm" style="border-radius: 0;color:brown;">
            <b style="color:#3a87ad;" onclick="goods_show('SKU状态','{{url("admin/kind/sku_show")}}?id='+@{{ d.goods_kind_id }},2,1400,800)">重用SKU</b>
        </button>
    @{{# } }}
</script>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <script type="text/html" id="test-table-operate-barDemo">
                    ...
                    <a class="layui-btn layui-btn-danger layui-btn-xs" title="删除产品" lay-event="del"><i class="layui-icon">&#xe640;</i></a>
                    @{{# if(d.goods_kind_sku_status != 1){ }}
                        <a class="layui-btn layui-btn-normal layui-btn-xs" title="释放产品SKU" lay-event="release"><i class="layui-icon">&#xe64f;</i></a>
                    @{{# }else if(d.goods_kind_sku_status === '1'){  }}
