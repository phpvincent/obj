...
@section('content')
    ...
    <script type="text/html" id="test-table-attr">
        <a title="属性详情" href="javascript:;"
           onclick="goods_show('查看属性详情','{{url("admin/kind/show")}}?id='+ @{{ d.goods_kind_id }},2,600,500)"
           class="ml-5"><span class="layui-btn layui-btn-radius layui-btn-xs layui-btn-primary"
                              style="background-color:#ccc;color:green;">查看属性详情</span></a>
    </script>
    {{--表格绑定产品的商品数量--}}
    <script type="text/html" id="test-table-num">
        <a title="商品列表" href="javascript:;"
           onclick="goods_info('{{url("admin/goods/index")}}?id='+@{{d.goods_kind_id}},@{{ d.num }})" class="ml-5"><span
                    class="layui-btn layui-btn-xs" style="background-color:#ccc;color:red;"> @{{d.num}} </span></a>
    </script>
                ...
                layui.config({
                    ...
                    var tableObj = table.render({
                        ...
                        , cols: [[
                            ...
                            , {
                                field: 'goods_buy_weight' + 'kg',
                                width: 100,
                                align: 'center',
                                title: '产品重量',
                                templet: '#test-table-weight'
                            }
