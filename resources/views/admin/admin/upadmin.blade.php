...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-update" enctype="multipart/form-data" action="{{url('admin/admin/upadmin')}}" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="check-box">
					能 <input type="radio" id="admin_worker" checked name="admin_worker" {{$admin->admin_worker == 1 ? 'checked' : ''}}  value="1">
					不能 <input type="radio" id="admin_worker" name="admin_worker"  {{$admin->admin_worker == 0 ? 'checked' : ''}} value="0">
				</div>
			</div>
		</div>
		<div class="row cl">
