                        ...
                        @foreach($goods_config as $k=>$v)
                            <div class="config">
                                <div class="row" style="margin-left: 0px;">
                                    ...
                                    <label for="goods_config_name" style="font-weight: bold;color: #D43">排序值(0~100):</label> <input type="text" style="width: 10%;margin-top:10px;" class="input-text attribute" value="{{$v->goods_config_order}}" placeholder="" id="goods_config_name" name="goods_config_name[{{$k}}][goods_config_order]" onblur="value=NumCheck(value)?value:0">
                                        ...
                                        @foreach($v->config_msg as $key=>$item)
                                            <div class="row" style="height: 40px;" >
                                                <div class="col-xs-9 col-sm-9" style="display: inline">
                                                    ...
                                                    <label>差额:</label> <input type="text" style="width: 15%;margin-top:10px; " class="input-text" value="{{$item['config_diff_price']}}" onkeyup="(this.v=function(){this.value=this.value.replace(/^\D*([0-9]\d*\.?\d{0,2})?.*$/,'$1');}).call(this)" onblur="this.v();"  id="goods_config" name="goods_config_name[{{$k}}][msg][{{$key}}][config_diff_price]">
