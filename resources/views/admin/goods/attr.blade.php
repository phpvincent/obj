                                        ...
                                        @foreach($v->config_msg as $key=>$item)
                                            <div class="row" style="height: 40px;" >
                                                <div class="col-xs-9 col-sm-9" style="display: inline">
                                                    ...
                                                    <label>差额:</label> <input type="text" style="width: 15%;margin-top:10px; " class="input-text" value="{{$item['goods_diff_price']}}" onkeyup="(this.v=function(){this.value=this.value.replace(/^\D*([1-9]\d*\.?\d{0,2})?.*$/,'$1');}).call(this)" onblur="this.v();"  id="goods_config" name="goods_config_name[{{$k}}][msg][{{$key}}][goods_diff_price]">
