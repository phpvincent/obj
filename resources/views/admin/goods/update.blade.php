	...
	<form class="form form-horizontal" id="form-goods-update" enctype="multipart/form-data" action="{{url('admin/goods/post_update')}}">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				秒:<input type="text" style="width: 10%;" class="input-text" value="{{explode(':',$goods->goods_end)[2]}}" placeholder="" id="goods_end3" name="goods_end3">
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
	...
	function get_cuxiao_html(now){
			          $('#cuxiaohtml').html('<div class="formControls col-xs-8 col-sm-9"><img src="/images/loading.gif"> </div>');
		$.ajax({
