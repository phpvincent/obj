                            ...
                            {{csrf_field()}}
                             <div class="layui-form-item">
                              ...
                              <div class="layui-input-inline">
                               <input type="text" class="layui-input" name="laydate" id="test-laydate" lay-verify="laydate" value="9:00:00 ~ 18:00:00" 
                                                   placeholder="工作时间">
                              </div>
                            </div>
                          <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="order_notice_phone" id="order_notice_phone" lay-verify="required" value="" placeholder="请附带区号" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">备注</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="order_notice_remark" id="order_notice_remark" lay-verify="required" value="" autocomplete="off" class="layui-input">
                                </div>
                            </div>
    ...
    <script>
        layui.config({
          ...
          form.on('submit',function(data){
             ...
             $.ajax({
                  url:"{{url('admin/order/order_notice/add')}}",
                  type:'post',
                  data:data.field,
                  datatype:'json',
