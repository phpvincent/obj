...
<div class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg" id="url_goods">
		<thead>
			<tr>
				<th scope="col" colspan="5">域名分配</th>
			</tr>
			<tr class="text-c">
				<th width="40">ID</th>
				<th width="40">对应单品</th>
...
/*		{'data':'course.profession.pro_name'},
		...
		"createdRow":function(row,data,dataIndex){
			var info='<a title="配置域名" href="javascript:;" onclick="ch_url(\'配置域名\',\'/admin/url/churl?id='+data.goods_id+'\',\'2\',\'800\',\'500\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe62e;</i></a>';
			if(data.url_type==0){
				var isroot='<span class="label label-default radius">×</span>';
				info+='<a title="开启" href="javascript:;" onclick="up_order(\''+data.goods_id+'\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6dc;</i></a>';
			}else if(data.url_type==1){
				var isroot='<span class="label label-success radius">√</span>';
				info+='<a title="关闭" href="javascript:;" onclick="close_order(\''+data.goods_id+'\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6de;</i></a>';
			}
