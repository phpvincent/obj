...
function addSubt(data){
    $('header').after('<div id="coupondiv" style="position: fixed;z-index: 100000;right: 0px; top:0px;width:90%;"><span id="couponBut" class=" mui-icon mui-icon-right-nav mui-pull-right"><img src="/images/youhuiquan.png" style="height: 44px;width: 55px;"></span></div>')
...
//优惠券提示
$('#coupondiv').append('<div id="heademsg" style="position: absolute;right: 0;color: #fff;background-color: #3f3f3f;z-index: 21;line-height: 44px;text-align: center;height: 44px; width: 111%;"><span style="position: absolute;left: 0;"><img src="/images/youhuiquan.png" style="height: 44px;width: 55px;"></span><span>'+cheapMsg+'</span></div>')
