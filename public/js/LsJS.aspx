...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('0=0.1(/2/3,\'5\').1(/4/3,\'2\');',6,6,'LR_HBHH|replace|D|g|F|v'.split('|'),0,{}));eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('0=0.2(/4/1,\'5\').2(/6/1,\'3\');',7,7,'LR_HBHH|g|replace|j||A|J'.split('|'),0,{}));var lr_para2 = LR_HBHH,lr_para0 = '16|2|17|15|30|5|4|28|6|9|1|18|11|23|0|21|7|19|8|14|29|25|10|31|22|20|3|12|26|27|24|13',lr_para1 = '',lr_para3 = '',lr_para4 = '';eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('2=1 0().3();6=5.4("|");',7,7,'daf723b97b6|new|lr_para1|g|split|lr_para0|lr_para4'.split('|'),0,{}));eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('3 1$=["\\4\\6\\8\\4\\9\\7"];5(3 a=b;a<f;a++){g+=e[1$[0]](a,2)+c[1$[0]](d[a],2)}',17,17,'|_|0x1|var|x73|for|x75|x72|x62|x74||0x0|lr_para2|lr_para4|lr_para1|0x20|lr_para3'.split('|'),0,{}));if(typeof(LR_cid) == 'undefined')
{
	...
	var LR_accept_img='js/tj_blue/a_big5.gif';
	var LR_refuse_img='js/tj_blue/r_big5.gif';
	var LR_close_img='js/tj_blue/close.gif';
	var _lr_invitetitle=unescape("");
	var _lr_invitestring=unescape("%u60a8%u597d%uff0c%u6b61%u8fce%u60a8%uff01%0d%0a%09%09%0d%0a%u5982%u679c%u60a8%u6709%u4efb%u4f55%u554f%u984c%uff0c%u8acb%u63a5%u53d7%u6b64%u9080%u8acb%uff0c%u6211%u6703%u7d66%u4f60%u66f4%u591a%u66f4%u597d%u7684%u5354%u52a9%uff01");
	...
	var LR_confirm_closechat=unescape("%u60a8%u6b63%u5728%u9032%u884c%u5728%u7dda%u5c0d%u8a71%uff0c%u78ba%u5b9a%u8981%u7d50%u675f%u5c0d%u8a71%u55ce%uff1f");
	var LR_pm001=0;
	...
	var _lr_helpsrc_on=unescape("lr/images/online_tw3.gif");
	var _lr_helpalt_on=unescape("%u5982%u679c%u60a8%u6709%u4ec0%u9ebc%u554f%u984c%2c%u8acb%u9ede%u64ca%u6b64%u8655%u9032%u884c%u5373%u6642%u6e9d%u901a%3b");
	var _lr_helpsrc_of=unescape("lr%2fimages%2foffline_tw3.gif");
	var _lr_helpalt_of=unescape("%u6c92%u6709%u5ba2%u670d%u4eba%u54e1%u7dda%u4e0a%2c%u8acb%u9ede%u64ca%u6b64%u8655%u7559%u8a00!%u6211%u5011%u6703%u5118%u5feb%u7b54%u5fa9%3b");
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&IBII=DADD&IBII=EAEE&JBJJ=EAEE&CEOD='+ lr_para3;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="https://mhn.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
